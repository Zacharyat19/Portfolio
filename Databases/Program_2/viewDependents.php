            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
						...
						<a href="createDependent.php" class="btn btn-success pull-right">Add Dependents</a>
                    </div>
<?php
    // Include config file
    //require_once "config.php";
    ...
    if($stmt = mysqli_prepare($link, $sql)){
       ...
       $param_Ssn = ($_SESSION["Ssn"]);
        ...
        if(mysqli_stmt_execute($stmt)){
			...
			echo"<h4> Dependents for SSN =".$param_Ssn."</h4><p>";
			if(mysqli_num_rows($result) > 0){
				echo "<table class='table table-bordered table-striped'>";
                    echo "<thead>";
                        echo "<tr>";
                            echo "<th width = 20%>Dependent Name</th>";
                            echo "<th>Sex</th>";
