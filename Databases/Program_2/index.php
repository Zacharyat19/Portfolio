...
//		include "header.php";
    ...
    <div class="wrapper">
        <div class="container-fluid">
		    ...
		    $sql = "SELECT Ssn,Fname,Lname,Salary, Address, Bdate, PayLevel(Ssn) as Level, Super_ssn, Dno FROM EMPLOYEE";
                    $sql = "SELECT Ssn,Fname,Lname,Salary, Address, Bdate, 'Insert your function' as Level, Super_ssn, Dno FROM EMPLOYEE";
