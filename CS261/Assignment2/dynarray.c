...
/*
 * This function returns the value at the front of the array.
 *
 * Params:
 *   da - the dynamic array in which to return a value.  May not be NULL.
 */
void* return_first(struct dynarray* da) {
  return da->data[0];
}